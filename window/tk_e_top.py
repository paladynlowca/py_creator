...
from window.tk_e_popup import TkEditorNewPopup, TkEditorSavePopup, TkEditorInitScenePopup, TkEditorNameAuthorPopup
from window.tk_settings import lang, functions


class TkEditorTopMenu(Frame):
    ...
    def _scene(self):
        TkEditorInitScenePopup(self._game)
        pass

    def _name_author_edit(self):
        TkEditorNameAuthorPopup(self._game)
        pass
