...
class TkEditorEditPopup(Toplevel):
...
class TkEditorPropertyPopup(TkEditorEditPopup):
...
class TkEditorTextPopup(TkEditorPropertyPopup):
    def __init__(self, _code_: Code, _property_: str, _value_: str):
...
class TkEditorIntPopup(TkEditorPropertyPopup):
    def __init__(self, _code_: Code, _property_: str, _value_: str):
        super().__init__(_code_, _property_, _value_)
...
class TkEditorBoolPopup(TkEditorPropertyPopup):
    def __init__(self, _code_: Code, _property_: str, _value_: str):
        super().__init__(_code_, _property_, _value_)
...
class TkEditorElementsPopup(TkEditorEditPopup):
...
class TkEditorSinglePopup(TkEditorElementsPopup):
    def __init__(self, _code_: Code, _type_: str, _values_: List[Code]):
...
class TkEditorMultiPopup(TkEditorElementsPopup):
    def __init__(self, _code_: Code, _type_: str, _values_: List[Code]):
        super().__init__(_code_, _type_, _values_)
        self._single = False
        self._build()
...
class TkEditorSelectPopup(TkEditorEditPopup):
